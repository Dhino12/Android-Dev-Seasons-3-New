...
class MyEditText : AppCompatEditText, View.OnTouchListener {
    ...
    private fun showClearButton() {
        setButtonDrawables(endOfTheNext = clearButtonImage)
    }
    ...
    private fun setButtonDrawables (
        ...
        topOfTheNext: Drawable? = null,
        endOfTheNext: Drawable? = null,
        bottomOfTheNext: Drawable? = null
    ) {
        setCompoundDrawablesWithIntrinsicBounds(
            startOfTheNext, topOfTheNext, endOfTheNext, bottomOfTheNext
        )
    }
