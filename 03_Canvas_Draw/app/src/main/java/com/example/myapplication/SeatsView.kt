...
import com.example.myapplication.Seat
...
class SeatsView : View {
    ...
    override fun onTouchEvent(event: MotionEvent?): Boolean {
        ...
        val widthColumnOne = (halOfWidth - 300F)..(halOfWidth - 100F)
        val widthColumnTwo = (halOfWidth + 100F)..(halOfWidth + 300F)

        val heightRowOne = (halOfHeight - 600F)..(halOfHeight - 400f)
        val heightRowTwo = (halOfHeight - 300F)..(halOfHeight - 100F)
        val heightRowTree = (halOfHeight + 0F)..(halOfHeight + 200F)
        val heightRowFour =(halOfHeight + 300F)..(halOfHeight + 500F)
